...
- Examples of injecting javascript files on a per page basis (see `syllabus/single.html`)
...
List pages such as the homepage, syllabus and team can have a Hero image. 
